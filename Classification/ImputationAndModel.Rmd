...
write.csv(answer_final,"C:/Users/ajtpa/Desktop/Stat 388 Predictive Analytics/Homework/Project/Stat388_Project/Classification/Submission.csv", row.names = FALSE)
```
...
model <- gbm(rain_tomorrow~., distribution = "gaussian", n.trees = 500, data = train_forest)
summary(model)
